                    ...
                    y.particles.forEach(function (ot, mn) {
                      ot.update(),
                        (ot.y > M.height || ot.y < -100 || ot.x > M.width + 100 || ot.x < -100) &&
                          (xe && rt <= ie ? (y.particles[mn] = y.getParticle()) : y.removeParticleAt(mn));
                    }),
                    Ft > 0 || rt < ie
                  );
                }),
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    function xt(e, t) {
      ...
      if (![e, t].every(n => j.plainObject(n) || j.array(n))) throw new Error("Expected plain objects or array");
      return {
        added: (n, r) => {
          try {
    ...
    function $e(e) {
      ...
      for (var t = Xe(10) ? document.body : null, n = e.offsetParent || null; n === t && e.nextElementSibling; )
    ...
    function sn(e, t) {
      ...
      var u = je({ top: o.top - a.top - c, left: o.left - a.left - p, width: o.width, height: o.height });
    ...
    function kr(e, t, n) {
      ...
      return (
        r.forEach(function (i) {
          ...
          i.enabled &&
            Sr(o) &&
            ((t.offsets.popper = je(t.offsets.popper)), (t.offsets.reference = je(t.offsets.reference)), (t = o(t, i)));
        }),
        t
      );
    }
    function Ai() {
      if (!this.state.isDestroyed) {
        ...
        (e.offsets.reference = xr(this.state, this.popper, this.reference, this.options.positionFixed)),
          (e.placement = Rr(
      ...
      t &&
        (n && e
          ? (console.groupCollapsed(`%creact-joyride: ${n}`, "color: #ff0044; font-weight: bold; font-size: 12px;"),
            Array.isArray(e)
              ? e.forEach(o => {
                  j.plainObject(o) && o.key ? i.apply(console, [o.key, o.value]) : i.apply(console, [o]);
                })
              : i.apply(console, [e]),
            console.groupEnd())
    ...
    function qe(e, t) {
      var n, r, i, o, a, s;
      let l = t ?? {},
        c = Ct.default.all([Za, rs(e), l], { isMergeableObject: j.plainObject }),
        p = ns(e, c),
        u = Ot(Ne(c.target), c.disableScrollParentFix),
        f = Ct.default.all([Qa, (n = e.floaterProps) != null ? n : {}, (r = c.floaterProps) != null ? r : {}]);
      return (
        (f.offset = c.offset),
        ...
        {
          ...c,
          locale: Ct.default.all([Xr, (s = e.locale) != null ? s : {}, c.locale || {}]),
          floaterProps: f,
    ...
    function Qr(e, t = !1) {
      return j.plainObject(e)
        ? e.target
          ? !0
          : (Me({ title: "validateStep", data: "target is missing from the step", warn: !0, debug: t }), !1)
    ...
    function hs(e) {
      let {
        ...
        J = { primary: R };
      return (
        r && ((J.primary = o ? K : B), F && (J.primary = V("span", null, J.primary, " (", i + 1, "/", s, ")"))),
        J.primary &&
          (J.primary = V(
            "button",
        ...
        I &&
          ...
          (J.skip = V(
            "button",
            { "aria-live": "off", "data-test-id": "button-skip", style: x.buttonSkip, type: "button", ...l },
            te
          )),
        !f &&
          i > 0 &&
          (J.back = V("button", { "data-test-id": "button-back", style: x.buttonBack, type: "button", ...t }, P)),
        (J.close = !b && V(ds, { "data-test-id": "button-close", styles: x.buttonClose, ...n })),
        V(
          "div",
          {
            key: "JoyrideTooltip",
          ...
          !m &&
            V("div", { style: x.tooltipFooter }, V("div", { style: x.tooltipFooterSpacer }, J.skip), J.back, J.primary),
          J.close
        )
      );
    }
...
`).length,
      ...
      return E.createElement(
        ...
        o === "1:Intro"
          ...
          : E.createElement(xs, { step: o, steps: K, onClose: F, onComplete: I })
      );
    }
    var hr,
      Wo,
...
Valid keys: ` +
                ...
                function pe(S) {
                  var N = typeof S;
                  return Array.isArray(S) ? "array" : S instanceof RegExp ? "object" : tt(N, S) ? "symbol" : N;
                }
                function fe(S) {
        ...
        _.domElement = e =>
          _.object(e) && !_.plainObject(e) && e.nodeType === 1 && _.string(e.nodeName) && hi.every(t => t in e);
        _.empty = e =>
        ...
        (Qa = {
          ...
          (Xr = { back: "Back", close: "Close", last: "Last", next: "Next", open: "Open the dialog", skip: "Skip" }),
          (Za = {
            event: "click",
            placement: "bottom",
            offset: 10,
        ...
        (ys = hs),
          ...
          (gs = class extends _e {
            ...
            componentDidUpdate(e) {
              ...
              let {
                ...
                P = o && l === e.index;
              if (
                (v && (x || P) && r({ ...T, index: e.index, lifecycle: W.COMPLETE, step: e.step, type: ve.STEP_AFTER }),
                u.placement === "center" &&
                  p === Y.RUNNING &&
                  b("index") &&
                  n !== $.START &&
              ...
              m("lifecycle", W.INIT, W.READY) && f.update({ lifecycle: lr(u) || F ? W.TOOLTIP : W.BEACON }),
                b("index") && Me({ title: `step:${c}`, data: [{ key: "props", value: this.props }], debug: a }),
          ...
          (eo = class extends _e {
            constructor(e) {
              ...
              (this.store = is({ ...e, controlled: r && j.number(i) })), (this.helpers = this.store.getHelpers());
            ...
            componentDidUpdate(e, t) {
              ...
              if (v("action", [$.NEXT, $.PREV, $.SKIP, $.CLOSE]) && v("status", Y.PAUSED)) {
                ...
                this.callback({ ...J, index: t.index, lifecycle: W.COMPLETE, step: se, type: ve.STEP_AFTER });
              }
              if (v("status", [Y.FINISHED, Y.SKIPPED])) {
                let se = qe(this.props, p[t.index]);
                r || this.callback({ ...J, index: t.index, lifecycle: W.COMPLETE, step: se, type: ve.STEP_AFTER }),
                ...
                P("status", [Y.IDLE, Y.READY], Y.RUNNING)
                  ...
                  : (v("status") || v("action", $.RESET)) && this.callback({ ...J, type: ve.TOUR_STATUS });
              this.scrollToStep(t),
                R.placement === "center" &&
                  a === Y.RUNNING &&
                  o === W.INIT &&
...
`),
    ...
    `),
            ...
            E.createElement(
              ...
              E.createElement(
                ...
                E.createElement(
                  ...
                  E.createElement(Cn, { ...r, onClick: r.onClick, variant: "solid" }, E.createElement(jn, null))
                ),
        ...
        (_s = at({ from: { opacity: 0 }, to: { opacity: 1 } })),
          ...
          (ks = at({ "0%": { transform: "rotate(0deg)" }, "100%": { transform: "rotate(360deg)" } })),
          (Ns = re.div(({ visible: e }) => ({
            position: "fixed",
            top: 0,
            left: 0,
