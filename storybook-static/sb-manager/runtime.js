...
var _u = V((SM, Cu) => {
  ...
  Cu.exports = /* @__PURE__ */ a(function (t) {
    ...
    for (
      ...
      u[c] = "$" + c;
    if (
      ((i = Function("binder", "return function (" + Qg(u, ",") + "){ return binder.apply(this,arguments); }")(o)),
      r.prototype)
    ) {
...
var zu = V((OM, Ru) => {
  ...
  Ru.exports = /* @__PURE__ */ a(function (t, r, n) {
    if (!t || (typeof t != "object" && typeof t != "function")) throw new dr("`obj` must be an object or a function`");
    if (typeof r != "string" && typeof r != "symbol") throw new dr("`property` must be a string or a symbol`");
...
var Cc = V(($M, Ec) => {
  var Ei = typeof Map == "function" && Map.prototype,
    hi = Object.getOwnPropertyDescriptor && Ei ? Object.getOwnPropertyDescriptor(Map.prototype, "size") : null,
    ...
    Ci =
      typeof Set ==
        "functi\
on" && Set.prototype,
    gi = Object.getOwnPropertyDescriptor && Ci ? Object.getOwnPropertyDescriptor(Set.prototype, "size") : null,
  ...
  Ec.exports = /* @__PURE__ */ a(function e(t, r, n, i) {
    ...
    if ((typeof n > "u" && (n = 0), n >= d && d > 0 && typeof t == "object")) return xi(t) ? "[Array]" : "[Object]";
    var h = Jy(o, n);
    if (typeof i > "u") i = [];
    ...
    if ((a(f, "inspect"), typeof t == "function" && !gc(t))) {
      var y = Ky(t),
        m = Nn(t, f);
      return (
        "[Function" + (y ? ": " + y : " (anonymous)") + "]" + (m.length > 0 ? " { " + nt.call(m, ", ") + " }" : "")
      );
    }
    if (Sc(t)) {
    ...
    if (!By(t) && !gc(t)) {
      var k = Nn(t, f),
        ...
        P = O || typeof t.constructor != "function" ? "" : t.constructor.name ? t.constructor.name + " " : "",
        M =
          P +
          (T || w
            ? "[" +
    ...
    for (var c in e)
      gt(e, c) &&
        ((r && String(Number(c)) === c && c < e.length) ||
          ...
          (vc.call(/[^\w$]/, c) ? n.push(t(c, e) + ": " + t(e[c], e)) : n.push(c + ": " + t(e[c], e))));
    if (typeof yi == "function")
      for (var p = 0; p < o.length; p++) bc.call(e, o[p]) && n.push("[" + t(o[p]) + "]: " + t(e[o[p]], e));
    return n;
  }
  a(Nn, "arrObjKeys");
});
  ...
  var _c = Dt(),
    ...
    Ti = /* @__PURE__ */ a(function (e, t) {
      for (var r = e, n; (n = r.next) !== null; r = n)
        if (n.key === t)
          return (r.next = n.next), (n.next = /** @type {NonNullable<typeof list.next>} */ e.next), (e.next = n), n;
    }, "listGetNode"),
      ...
      for (var u = "", c = 0; c < l.length; c += Pi) {
        for (var p = l.length >= Pi ? l.slice(c, c + Pi) : l, d = [], h = 0; h < p.length; ++h) {
          ...
          (h += 1),
            ...
            (d[d.length] =
              ot[240 | (f >> 18)] + ot[128 | ((f >> 12) & 63)] + ot[128 | ((f >> 6) & 63)] + ot[128 | (f & 63)]);
        }
        u += d.join("");
      }
      return u;
    ...
    kv = /* @__PURE__ */ a(function e(t, r, n, i, o, l, u, c, p, d, h, f, y, m, b, x, _, g) {
      ...
      for (var L = 0; L < T.length; ++L) {
        ...
        if (!(u && Z === null)) {
          ...
          var z = Dc();
          z.set(Mi, g),
            Nc(w, e(Z, R, n, i, o, l, u, c, n === "comma" && x && it(v) ? null : p, d, h, f, y, m, b, x, _, z));
        }
      }
      return w;
    }, "stringify"),
...
var zc = V((XM, Rc) => {
  ...
  var hr = Ai(),
    ...
    Lv = /* @__PURE__ */ a(function (t, r) {
      ...
      if (r.charsetSentinel)
        for (c = 0; c < l.length; ++c)
          l[c].indexOf("utf8=") === 0 &&
            (l[c] === Dv ? (p = "utf-8") : l[c] === Mv && (p = "iso-8859-1"), (u = c), (c = l.length));
      for (c = 0; c < l.length; ++c)
        if (c !== u) {
          var d = l[c],
            h = d.indexOf("]="),
    ...
    Nv = /* @__PURE__ */ a(function (e, t, r, n) {
      for (var i = n ? t : Hc(t, r), o = e.length - 1; o >= 0; --o) {
        ...
        if (u === "[]" && r.parseArrays)
          ...
          !r.parseArrays && p === ""
            ? (l = { 0: i })
            : !isNaN(d) && u !== p && String(d) === p && d >= 0 && r.parseArrays && d <= r.arrayLimit
            ? ((l = []), (l[d] = i))
            : p !== "__proto__" && (l[p] = i);
        }
        i = l;
    ...
    Bv = /* @__PURE__ */ a(function (t) {
      ...
      return {
        ...
        interpretNumericEntities:
          typeof t.interpretNumericEntities == "boolean" ? t.interpretNumericEntities : Ie.interpretNumericEntities,
  ...
  Rc.exports = function (e, t) {
    var r = Bv(t);
    if (e === "" || e === null || typeof e > "u") return r.plainObjects ? /* @__PURE__ */ Object.create(null) : {};
    for (
    ...
    return (function (e) {
      ...
      return (
        ...
        (r.t = function (n, i) {
          ...
          if (
            (r.r(o), Object.defineProperty(o, "default", { enumerable: !0, value: n }), 2 & i && typeof n != "string")
          )
            for (var l in n)
              r.d(
                o,
                ...
                },
                {
                  ...
                  value: /* @__PURE__ */ a(function () {
                    ...
                    if (this.options.tokenize)
                      for (var x = m.split(this.options.tokenSeparator), _ = 0, g = x.length; _ < g; _ += 1)
...
Key: `.concat(_ === "" ? "--" : _)
                          ...
                          if ((x._log('Full text: "'.concat(Z, '", score: ').concat(H.score)), x.options.tokenize)) {
                            for (
                              var N = Z.split(x.options.tokenSeparator), F = N.length, $ = [], Q = 0, ne = O.length;
                              Q < ne;
                              Q += 1
                            ) {
                              var ee = O[Q];
      ...
      function (e, t, r) {
        ...
        e.exports = function (o, l, u, c) {
          ...
          for (var L = [], W = 1, Z = w + E, G = 1 << (w <= 31 ? w - 1 : 30), R = 0; R < w; R += 1) {
            for (var z = 0, B = Z; z < B; )
              n(l, { errors: R, currentLocation: C + B, expectedLocation: C, distance: f }) <= k ? (z = B) : (Z = B),
            ...
            for (var F = H; F >= re; F -= 1) {
              ...
              if (
                ...
                N[F] & G && (W = n(l, { errors: R, currentLocation: $, expectedLocation: C, distance: f })) <= k)
              ) {
                if (((k = W), (O = $) <= C)) break;
                re = Math.max(1, 2 * C - O);
              }
    ...
    var r = {
        ...
        storeAPI: {
          ...
          namespace: /* @__PURE__ */ a(function (i, o, l) {
            ...
            if (
              (!c || !c.namespace) &&
              ((c = r.Store(this._id, this._area, this._ns + u + l)), (c._delim = l), this[u] || (this[u] = c), !o)
            )
...
var Zx = __STORYBOOK_CHANNELS__,
  { Channel: Jx, PostMessageTransport: ew, WebsocketTransport: tw, createBrowserChannel: Za } = __STORYBOOK_CHANNELS__;
        ...
        o.filter(function (h) {
          for (var f, y = Object.keys(h), m = 0; m < y.length; m += 1) {
            ...
            t.indexOf(x) === -1 ||
              ...
              (f = x),
              t.indexOf(b) === -1 || (b !== "innerHTML" && b !== "cssText" && b !== "itemprop") || (f = b);
          }
          if (!f || !h[f]) return !1;
...
var Qt = /* @__PURE__ */ a(function (e, t) {
  ...
  Ho = /* @__PURE__ */ a(function (e, t) {
    ...
    if (r) {
      for (
        var n = r.getAttribute("data-rh"), i = n ? n.split(",") : [], o = [].concat(i), l = Object.keys(t), u = 0;
        u < l.length;
        u += 1
      ) {
        var c = l[u],
...
lements. Refer to our API for more information."
      ...
      (r.render = function () {
        ...
        return (
          ...
          u
            ? /* @__PURE__ */ s.createElement(nn, be({}, l, { context: u.value, helmetData: void 0 }))
...
var Kh = /^#[a-fA-F0-9]{6}$/,
  ...
  Gh = /^rgb(?:a)?\(\s*(\d{1,3})\s*(?:,)?\s*(\d{1,3})\s*(?:,)?\s*(\d{1,3})\s*(?:,|\/)\s*([-+]?\d*[.]?\d+[%]?)\s*\)$/i,
  Yh = /^hsl\(\s*(\d{0,3}[.]?[0-9]+(?:deg)?)\s*(?:,)?\s*(\d{1,3}[.]?[0-9]?)%\s*(?:,)?\s*(\d{1,3}[.]?[0-9]?)%\s*\)$/i,
  Qh =
...
function kl(e, t, r) {
  ...
  if (typeof e == "object" && t === void 0 && r === void 0) return Tl("#" + nr(e.red) + nr(e.green) + nr(e.blue));
  throw new or(6);
}
a(kl, "rgb");
function Zo(e, t, r, n) {
...
function Fl(e) {
  let t = /* @__PURE__ */ a(o => (typeof window < "u" ? window.matchMedia(o).matches : !1), "getMatches"),
    [r, n] = J(t(e));
  function i() {
    n(t(e));
  }
  ...
  ct = /* @__PURE__ */ (function (e) {
    ...
    return (
      ...
      (r.getTimeouts = /* @__PURE__ */ a(function () {
        ...
        return (
          (o = l = u = i),
          i != null && typeof i != "number" && ((o = i.exit), (l = i.enter), (u = i.appear !== void 0 ? i.appear : l)),
          {
            exit: o,
            enter: l,
            appear: u,
...
var wn = /* @__PURE__ */ a(({ onNavigateToWhatsNew: e }) => {
    ...
    return /* @__PURE__ */ s.createElement(
      ...
      /* @__PURE__ */ s.createElement(
        gg,
        null,
        /* @__PURE__ */ s.createElement($l, { active: r === "npm", onClick: () => n("npm") }, "npm"),
        /* @__PURE__ */ s.createElement($l, { active: r === "pnpm", onClick: () => n("pnpm") }, "pnpm")
      ),
      /* @__PURE__ */ s.createElement(
        yg,
        null,
...
cumentation"
          ...
          /* @__PURE__ */ s.createElement(
            ...
            " ",
            /* @__PURE__ */ s.createElement(Le, { href: "https://chromatic.com", target: "_blank" }, "Chromatic"),
            " ",
            "and the",
            " ",
            /* @__PURE__ */ s.createElement(
...
var jl = /* @__PURE__ */ a(({ children: e }) => {
    let t = X(null),
      r = X(null),
      n = X(null),
      { isMobileMenuOpen: i, setMobileMenuOpen: o, isMobileAboutOpen: l, setMobileAboutOpen: u } = Ee();
    return /* @__PURE__ */ s.createElement(
      s.Fragment,
      null,
      /* @__PURE__ */ s.createElement(
...
var Cg = /* @__PURE__ */ a(() => {
  ...
  Ul = /* @__PURE__ */ a(({ menu: e, panel: t, showPanel: r }) => {
    let { isMobileMenuOpen: n, isMobilePanelOpen: i, setMobileMenuOpen: o, setMobilePanelOpen: l } = Ee(),
      u = Cg();
    return /* @__PURE__ */ s.createElement(
      _g,
      null,
...
var Pg = 100,
  ...
  Ag = /* @__PURE__ */ a(({ managerLayoutState: e, setManagerLayoutState: t, isDesktop: r, hasTab: n }) => {
    let i = s.useRef(e),
      [o, l] = J({
        ...e,
        isDragging: !1,
    ...
    return /* @__PURE__ */ s.createElement(
      ...
      i &&
        /* @__PURE__ */ s.createElement(
          s.Fragment,
          null,
          /* @__PURE__ */ s.createElement(Dg, null, /* @__PURE__ */ s.createElement(Jl, { ref: h }), n.slotSidebar),
          y &&
            /* @__PURE__ */ s.createElement(
              Fg,
              { position: p },
...
var $v = /* @__PURE__ */ a((e, t) => (e && t[e] ? `storybook-ref-${e}` : "storybook-preview-iframe"), "getActive"),
  Wv = I(we)(({ theme: e }) => ({
    display: "none",
  ...
  jc = /* @__PURE__ */ a(
    ({ refs: e, scale: t, viewMode: r = "story", refId: n, queryParams: i = {}, baseUrl: o, storyId: l = "*" }) => {
      let u = e[n]?.version,
        c = Kc({
          ...i,
          ...(u && { version: u }),
...
var { PREVIEW_URL: Qv, document: Xv } = ae,
  ...
  Jc = {
    ...
    render: /* @__PURE__ */ a(
      () =>
        /* @__PURE__ */ s.createElement(he, { filter: Zv }, ({ baseUrl: e, storyId: t, queryParams: r }) =>
          t
            ? /* @__PURE__ */ s.createElement(
                te,
                {
...
var { PREVIEW_URL: Jv } = ae,
  ...
  ep = {
    ...
    render: /* @__PURE__ */ a(
      () =>
        /* @__PURE__ */ s.createElement(he, { filter: eb }, ({ baseUrl: e, storyId: t, queryParams: r }) =>
          t
            ? /* @__PURE__ */ s.createElement(
                te,
...
var tb = I(te)(({ theme: e, animating: t, disabled: r }) => ({
  ...
  tp = {
    ...
    render: /* @__PURE__ */ a(
      () =>
        /* @__PURE__ */ s.createElement(he, { filter: rb }, ({ remount: e, storyId: t, api: r }) => {
          let [n, i] = J(!1),
            o = /* @__PURE__ */ a(() => {
              t && e();
            }, "remountComponent");
...
var ap = s.memo(
    /* @__PURE__ */ a(function ({ isShown: t, tools: r, toolsExtra: n, tabs: i, tabId: o, api: l }) {
      return i || r || n
        ? /* @__PURE__ */ s.createElement(
            lb,
            {
...
bar",
            ...
            /* @__PURE__ */ s.createElement(
              ...
              /* @__PURE__ */ s.createElement(cb, null, /* @__PURE__ */ s.createElement(op, { key: "right", list: n }))
            )
          )
        : null;
    }, "ToolbarComp")
          ...
          /* @__PURE__ */ s.createElement(
            ...
            t &&
              ...
              /* @__PURE__ */ s.createElement(
                pp,
                null,
                /* @__PURE__ */ s.createElement(sn, { id: "preview-loader", role: "progressbar", progress: f })
              ),
            /* @__PURE__ */ s.createElement(
              dp,
...
var hb = [mp()],
  ...
  { PREVIEW_URL: wb } = ae,
  Eb = /* @__PURE__ */ a(e => e.split("/").join(" / ").replace(/\s\s/, " "), "splitTitleAddExtraSpace"),
  Cb = /* @__PURE__ */ a(e => {
  ...
  _b = /* @__PURE__ */ a(
    ({
      ...
      let { layout: r, location: n, customQueryParams: i, storyId: o, refs: l, viewMode: u, path: c, refId: p } = t,
        d = e.getData(o, p),
...
var { document: xp, window: kb } = ae,
  ...
  wp = /* @__PURE__ */ a((e, t) => `${xp.location.pathname}?path=/${e.type}/${Kn(e.id, t)}`, "getLink");
...
var Nt = /* @__PURE__ */ a((e, t = !1) => {
  ...
  Ft = /* @__PURE__ */ a((e, t) => (!e || !t ? !1 : e === t ? !0 : Ft(e.parentElement || void 0, t)), "isAncestor"),
...
ons, and all stories are filtered away."
  ...
  Fp = /* @__PURE__ */ a(
    ({ isMain: e }) =>
      /* @__PURE__ */ s.createElement(Hr, null, /* @__PURE__ */ s.createElement(Ap, { size: e ? 17 : 5 })),
    "LoaderBlock"
  );
          ...
          ze,
          {
            ...
            tooltip: /* @__PURE__ */ s.createElement(
              ...
              /* @__PURE__ */ s.createElement(
                ...
                (e === "error" || e === "empty") && /* @__PURE__ */ s.createElement(Ub, { url: t.url }),
                e ===
                  "\
ready" &&
                  /* @__PURE__ */ s.createElement(
                    s.Fragment,
                    null,
                    /* @__PURE__ */ s.createElement(Wb, { url: t.url, componentCount: o, leafCount: l }),
                    t.sourceUrl && /* @__PURE__ */ s.createElement(Vb, { url: t.sourceUrl })
                  ),
                e === "auth" && /* @__PURE__ */ s.createElement(Kb, { ...t }),
                t.type === "auto-inject" && e !== "error" && /* @__PURE__ */ s.createElement(Gb, null),
...
var Qb = I(rl)({
  ...
  zr = /* @__PURE__ */ a(e => Zb.reduce((t, r) => (e.includes(r) ? r : t), "unknown"), "getHighestStatus");
function jn(e, t) {
...
// src/manager/components/sidebar/useExpanded.ts
var { document: ji } = ae,
  G0 = /* @__PURE__ */ a(({ refId: e, data: t, initialExpanded: r, highlightedRef: n, rootIds: i }) => {
...
var Q0 = I.div(e => ({
 ...
 0 6 6",
  ...
  J0 = s.memo(
    /* @__PURE__ */ a(function ({ setExpanded: t, isFullyExpanded: r, expandableDescendants: n, ...i }) {
      ...
      let h = X(null),
        ...
        { expandableDescendants: x } = j(
          () =>
            [...m, ...y].reduce(
              (w, T) => (
                (w.expandableDescendants[T] = at(i, T, !1).filter(P => !["story", "docs"].includes(i[P].type))), w
              ),
...
var { document: Ui, window: Wd } = ae,
  Vd = /* @__PURE__ */ a(e => (e ? { itemId: e.storyId, refId: e.refId } : null), "fromSelection"),
  Kd = /* @__PURE__ */ a(({ containerRef: e, isLoading: t, isBrowsing: r, dataset: n, selected: i }) => {
    let o = Vd(i),
      l = X(o),
      [u, c] = J(o),
      p = de(),
  ...
  qd = ws(({ theme: e }) => {
    ...
    if (n === null)
      return t === null
        ? null
        : r
        ? /* @__PURE__ */ s.createElement(Ud, { href: r, target: o, dangerouslySetInnerHTML: { __html: t } })
...
var lI = I.div(({ theme: e }) => ({
  ...
  Qd = /* @__PURE__ */ a(
    ({ menuHighlighted: e = !1, menu: t, skipLinkHref: r, extra: n, isLoading: i, onMenuClick: o, ...l }) =>
      /* @__PURE__ */ s.createElement(
        uI,
        { ...l },
        r &&
  ...
  return function (n) {
    ...
    return t.some(function (u) {
      return (
        ...
        n.preventDownshiftDefault || (n.hasOwnProperty("nativeEvent") && n.nativeEvent.preventDownshiftDefault)
      );
    });
  };
}
...
var lf = yo(function (e, t) {
  ...
  MI = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u" ? qt : K,
  Mf =
    "useId" in s
      ? /* @__PURE__ */ a(function (t) {
          var r = t.id,
  ...
  var E = j(
    ...
    Z = A(
      function (R, z) {
        ...
        return (
          ee.disabled || ((me.onClick = ue(N, Se)), (me.onKeyDown = ue(F, Pe))), C("getToggleButtonProps", pe, Q, f), me
        );
      },
      [u, x, _, S, C, E]
    ),
    ...
    L = A(
      function (H, N) {
        ...
        return U(
          ...
          (F["aria-activedescendant"] = _e.isOpen && _e.highlightedIndex > -1 ? g.getItemId(_e.highlightedIndex) : ""),
      ...
      (this.unsubs = []),
        ...
        (this.getFurthestMeasurement = (r, n) => {
          ...
          return o.size === this.options.lanes
            ? Array.from(o.values()).sort((l, u) => (l.end === u.end ? l.index - u.index : l.end - u.end))[0]
            : void 0;
        }),
        ...
        (this._measureElement = (r, n) => {
          ...
          o !== r &&
            (o && this.observer.unobserve(o), this.observer.observe(r), this.measureElementCache.set(i.key, r));
        ...
        (this.getOffsetForAlignment = (r, n) => {
          let i = this.getSize();
          n === "auto" &&
            (r <= this.scrollOffset ? (n = "start") : r >= this.scrollOffset + i ? (n = "end") : (n = "start")),
          ...
          this._scrollToOffset(o, { adjustments: void 0, behavior: i }),
            i !== "smooth" &&
              ...
              (this.scrollToIndexTimeoutId = setTimeout(() => {
                if (((this.scrollToIndexTimeoutId = null), this.measureElementCache.has(this.options.getItemKey(r)))) {
  ...
  K(() => {
    let n = /* @__PURE__ */ a(i => {
      ...
      let o = t.options.count,
        ...
        d = /* @__PURE__ */ a(() => document.querySelector(`[data-index="${o - 1}"]`), "getLastElement");
          ...
          /* @__PURE__ */ s.createElement(
            ...
            /* @__PURE__ */ s.createElement(
              ...
              /* @__PURE__ */ s.createElement(
                IS,
                null,
                /* @__PURE__ */ s.createElement(SS, null, /* @__PURE__ */ s.createElement(bn, null)),
                ...
                i && /* @__PURE__ */ s.createElement(xS, null, /* @__PURE__ */ s.createElement(mt, null))
              ),
    ...
    let [r, n] = J(!1),
      ...
      x = A(() => {
        ...
        let g = Qe.getChannel(),
          v = /* @__PURE__ */ a(S => {
            S.id === u &&
              (S.success ? y(S.payload.files) : d({ error: S.error }), g.off(qr, v), n(!1), (c.current = null));
          }, "set");
        return (
          g.on(qr, v),
          u !== "" && c.current !== u
      ...
      let { value: n, indices: i } = r,
        { nodes: o } = i.reduce(
          ({ cursor: l, nodes: u }, [c, p], d, { length: h }) => (
            ...
            d === h - 1 && u.push(/* @__PURE__ */ s.createElement("span", { key: `${d}-3` }, n.slice(p + 1))),
            { cursor: p + 1, nodes: u }
          ),
          { cursor: 0, nodes: [] }
        );
...
0 0 14 14",
        ...
        /* @__PURE__ */ s.createElement(
          ...
          /* @__PURE__ */ s.createElement(YS, null, /* @__PURE__ */ s.createElement(Km, { match: u }, t.name)),
          /* @__PURE__ */ s.createElement(
            QS,
            null,
            t.path.map((d, h) =>
              /* @__PURE__ */ s.createElement(
                "span",
                { key: h },
                /* @__PURE__ */ s.createElement(Km, { match: c.find(f => f.arrayIndex === h) }, d)
              )
            )
          )
        ),
...
var tx = /* @__PURE__ */ a(() => !0, "filterNone"),
  rx = /* @__PURE__ */ a(({ status: e = {} }) => Object.values(e).some(t => t?.status === "warn"), "filterWarn"),
  nx = /* @__PURE__ */ a(({ status: e = {} }) => Object.values(e).some(t => t?.status === "error"), "filterError"),
  ox = /* @__PURE__ */ a(
    ...
    let t = j(() => {
      ...
      n = A(
        i => {
          ...
          l !== 0 &&
            (l === -1 ? (r.current = [i, ...o]) : (r.current = [i, ...o.slice(0, l), ...o.slice(l + 1)]),
            Gm(r.current));
        },
        [r]
      );
  ...
  Xm = s.memo(
    /* @__PURE__ */ a(function ({
      ...
      return /* @__PURE__ */ s.createElement(
        ...
        x
          ? null
          : /* @__PURE__ */ s.createElement(cx, { className: "sb-bar" }, /* @__PURE__ */ s.createElement(Um, null))
      );
    }, "Sidebar")
  );
...
`
  ...
  Zm = /* @__PURE__ */ a((e, t, r, n, i, o, l) => {
    ...
    return j(
      () => [p, ...(e.whatsNewData?.status === "SUCCESS" ? [y] : []), d, m, b, x, _, g, v, S, C, E, k, O, w, ...T()],
  ...
  rh = /* @__PURE__ */ a(
    ({ onNavigateToWhatsNew: e }) =>
      /* @__PURE__ */ s.createElement(
        yx,
        null,
        /* @__PURE__ */ s.createElement(vx, null, /* @__PURE__ */ s.createElement(un, { alt: "Storybook" })),
        ...
        /* @__PURE__ */ s.createElement(
          ...
          /* @__PURE__ */ s.createElement(
            ...
            "Open source software maintained by",
            " ",
            /* @__PURE__ */ s.createElement(th, { href: "https://www.chromatic.com/" }, "Chromatic"),
            " and the",
            " ",
            /* @__PURE__ */ s.createElement(
              th,
...
var sh = I.div({
  ...
  Fx = /* @__PURE__ */ a(({ isNotificationsEnabled: e, onToggleNotifications: t, onCopyLink: r }) => {
    let n = De(),
      [i, o] = J("Copy Link"),
      l = /* @__PURE__ */ a(() => {
      ...
      /* @__PURE__ */ s.createElement(
        ...
        /* @__PURE__ */ s.createElement(
          ...
          /* @__PURE__ */ s.createElement(
            ...
            n && /* @__PURE__ */ s.createElement(Ya, { id: "whats-new", title: "What's new?", changeTab: e }),
...
uts",
        ...
        /* @__PURE__ */ s.createElement(
          ...
          /* @__PURE__ */ s.createElement(xr, { path: "about" }, /* @__PURE__ */ s.createElement(nh, { key: "about" })),
          /* @__PURE__ */ s.createElement(
            xr,
            { path: "whats-new" },
